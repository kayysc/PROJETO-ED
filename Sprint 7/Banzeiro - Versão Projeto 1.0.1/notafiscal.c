...
int detalhesDaCompra(char assentosEscolhidos[MAX_PASSAGENS][5], int totalAssentos, Rota rota, char ***assentos, struct cliente **head_cliente) {
    ...
    if (resposta == 'S' || resposta == 's') {
        ...
        if (cliente_encontrado != NULL) {
            ...
            scanf(" %c", &resposta);
            if (resposta == 'S' || resposta == 's') {
                finalizarCompra(totalAssentos, rota, assentosEscolhidos, cliente_encontrado->nome, cliente_encontrado->cpf, assentos); // Passando a matriz de assentos
            } else {
                printf("\n       Compra cancelada! Voltando ao Menu Principal...\n");
                // Liberar os assentos selecionados
            	liberarAssentosSelecionados(assentos, assentosEscolhidos, totalAssentos);
        ...
        if (resposta == 'S' || resposta == 's') {
            ...
            scanf(" %c", &resposta);
            if (resposta == 'S' || resposta == 's') {
                finalizarCompra(totalAssentos, rota, assentosEscolhidos, (*head_cliente)->nome, (*head_cliente)->cpf, assentos); // Passando a matriz de assentos
            } else {
                printf("\n       Compra cancelada! Voltando ao Menu Principal...\n");
                // Liberar os assentos selecionados
            	liberarAssentosSelecionados(assentos, assentosEscolhidos, totalAssentos);
            ...
            scanf(" %c", &resposta);
            if (resposta == 'S' || resposta == 's') {
                finalizarCompra(totalAssentos, rota, assentosEscolhidos, cliente_temp.nome, cliente_temp.cpf, assentos); // Passando a matriz de assentos
            } else {
                printf("\n       Compra cancelada! Voltando ao Menu Principal...\n");
                // Liberar os assentos selecionados
            	liberarAssentosSelecionados(assentos, assentosEscolhidos, totalAssentos);

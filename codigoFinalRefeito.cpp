...
void menuRotas(){
    ...
    while (!sair) {
        ...
        printf("0. Sair\n");
        printf("1. Listar Rotas Disponíveis\n");
        printf("2. Filtros\n");
        printf("Escolha uma opção: ");
        scanf("%d", &escolha);
...
void menuGerente() {
    ...
    do {
        ...
        printf("\t 2. Gerenciar Funcionário\n");
        printf("\t  3. Listar Funcionários\n");
        
        printf("\t 4. Cadastrar Embarcação\n");
		printf("\t 5. Gerenciar Embarcação\n");
        ...
        switch (opcao) {
            ...
            case 5:
            	system("cls");
                printf("Gerencia de embarcações...\n\n");
                system("pause");
...
void login() {
    ...
    if (carregarFuncionario(login, &usuario)) {
        ...
        if (strcmp(usuario.senha, senha) == 0) {
            ...
            animacaoBarco();  // Exibe a animação do barco
